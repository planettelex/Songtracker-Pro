...
{
    [TestClass]
    public class AddMerchandiseProductTests : TestsBase
    {
        [TestMethod]
        public void TaskBaseSuccessTest()
        {
            ...
            var testMerchandiseItem = TestsModel.MerchandiseItem(testArtist);
            ...
            var task = new AddMerchandiseProduct(DbContext);
            ...
            var merchandiseProductId = result.Data;
            ...
            Assert.IsNotNull(merchandiseProduct.MerchandiseItem.Artist);
            Assert.AreEqual(testArtist.Name, merchandiseProduct.MerchandiseItem.Artist.Name);
            Assert.AreEqual(testArtist.Email, merchandiseProduct.MerchandiseItem.Artist.Email);
        ...
        {
            var task = new AddMerchandiseProduct(EmptyDbContext);
