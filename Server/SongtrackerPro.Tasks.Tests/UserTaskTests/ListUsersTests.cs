...
namespace SongtrackerPro.Tasks.Tests.UserTaskTests
{
    ...
    public class ListUsersTests : TestsBase
    {
        ...
        public void TaskSuccessTest()
        {
            ...
            testArtistUser1.UserRoles = SystemUserRoles.ArtistMember;
            ...
            testArtistUser1.UserRoles = SystemUserRoles.ArtistMember | SystemUserRoles.VisualArtist;
            ...
            testManagerUser.UserRoles = SystemUserRoles.ArtistManager;
